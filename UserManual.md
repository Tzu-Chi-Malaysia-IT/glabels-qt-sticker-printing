...
Open the program: in the "\bin\glabels-qt.exe" (For Better and Safer printing, please copy the “gLabels” folder to your computer)<img src="docs/images/image1.png" style="width:6.26806in;height:4.27917in" />
...
Choose “New Product”, then Enter a recognizable name for the custom template.

For example: **Custom Travel Bag Label 57.1 x 130.5 mm**

Using the label dimensions in the name makes the template easier to identify later.

Click Next.

<img src="docs/images/image24.png" style="width:4.96768in;height:3.41342in" />

<img src="docs/images/image25.png" style="width:5.71887in;height:3.90804in" />

## Select the Page Size

Choose the paper size that will be loaded into the printer.
...
Choose the shape that most closely matches the physical label.
...
Enter the physical width and height of one label.
...
<img src="docs/images/image29.png" style="width:6.26806in;height:4.28333in" />

Just pick one layout (IDK what is this) and click **Next.**

Enter the number of label columns and rows on one sheet.
...
Click **Next**. <img src="docs/images/image30.png" style="width:6.26806in;height:4.29097in" /> Enter the margins and spacing according to the physical label sheet.
...
Horizontal pitch = Label width + Horizontal gap

Vertical pitch = Label height + Vertical gap

If the page contains only one label, the horizontal and vertical pitch values may not affect the result.

## Complete the Template <img src="docs/images/image31.png" style="width:6.26806in;height:4.30556in" />
...
On the startup screen, click **New** to create a new label project.

Alternatively, if the main editing window is already open, select: **File \> New**

The **New Label or Card** window will appear.

<img src="docs/images/image32.png" style="width:4.76593in;height:2.56778in" />

## Choose “Search all” tab and get template we want.

In the template selection window, choose the **Search all** tab.

Use the search field or browse the available templates to locate the required label product.
...
Click **Next** or **Apply** to continue. <img src="docs/images/image33.png" style="width:5.84744in;height:4.5226in" />

**Important:** Confirm the product number and label dimensions before continuing. A template with a similar appearance may still have different margins, spacing, or label dimensions.
...
The orientation can also be changed later by rotating the objects on the label, but selecting the correct orientation at the beginning makes the design process easier. <img src="docs/images/image34.png" style="width:6.26806in;height:3.37639in" />

## Set measure unit

Go to “**Edit** \> **Preferences**”

Set the measurement unit used by the label editor.
...
The selected unit will be used for object position, width, height, margins, and spacing.

<img src="docs/images/image35.png" style="width:2.56689in;height:2.60023in" /> <img src="docs/images/image36.png" style="width:4.26704in;height:3.88367in" />
...
**Objects \> Create \> Image**

An image placeholder will appear on the label.
...
<img src="docs/images/image39.png" style="width:3.4753in;height:4.10036in" />

## Save

<img src="docs/images/image40.png" style="width:2.72524in;height:4.27537in" />
